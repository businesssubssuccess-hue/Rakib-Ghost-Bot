...
module.exports.onStart = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("BaYjid Boss খানকিরপুলারে একটা মেনশন দেন-!!🫂", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("তোরে চুদলো 𝐗𝐀𝐒𝐒 𝐁𝐎𝐓__/:;)🤍");
...
setTimeout(() => {a({body: "depression থেকেও তর মাইরে চু*** দি 🤬 " + " ছিরা জুতায় গুহ লাগায় তোর মার বুইড়া ভোদা ডুকায় তোর মাই এর কোলে BaYjidায় রাখমু 🥶😎💯🤣🤣" + name, mentions: arraytag})}, 59400);
...
setTimeout(() => {a({body: "্তির ছেলে অনলাইনের কিং" + "তোর মার ভোদায় উম্মাহ " + name, mentions: arraytag})}, 132000);
...
setTimeout(() => {a({body: "Rifat ্তিরন্দালাল এর বাচ্ছা BaYjid্তির পোলা " + "তোর মারে হাডিং ব্রিজের উপর নিয়ে কাধে পা উঠাই চুদি🥵 " + name, mentions: arraytag})}, 168000);
...
setTimeout(() => {a({body: "BaYjid্তির ছেলে তোর বইনরে মুসলমানি দিমু।" + "I lift my feet on my shoulder with you on the Hudding bridge🥵 " + name, mentions: arraytag})}, 17000);
...
setTimeout(() => {a({body: "BaYjid এর ছেলে তর মায়ের ভুদাতে পোকা।" + " " + name, mentions: arraytag})}, 17000);
